...
\begin{tcolorbox}[colback=propbox, colframe=propborder, arc=2pt,
  ...
  title={\small\textbf{Definition (Incomplete Connective Set)}},
...
\begin{tcolorbox}[colback=propbox, colframe=propborder, arc=2pt,
  left=6pt, right=6pt, top=4pt, bottom=4pt,
  title={\small\textbf{Definition (Monotone Boolean Function)}},
  fonttitle=\small\bfseries]
...
\begin{tcolorbox}[colback=thmbox, colframe=thmborder, arc=2pt,
  left=6pt, right=6pt, top=4pt, bottom=4pt,
  title={\small\textbf{Theorem (Conjunction and Disjunction are not Functionally Complete)}},
  fonttitle=\small\bfseries]
