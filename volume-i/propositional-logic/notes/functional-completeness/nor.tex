...
\begin{tcolorbox}[colback=propbox, colframe=propborder, arc=2pt,
  ...
  title={\small\textbf{Definition (NOR Connective)}},
...
\(\operatorname{NOR}(\varphi,\psi)\) means the negation of the disjunction of
\(\varphi\) and \(\psi\).
\end{remark*}
...
\begin{tcolorbox}[colback=propbox, colframe=propborder, arc=2pt,
  left=6pt, right=6pt, top=4pt, bottom=4pt,
  title={\small\textbf{Definition (NOR-Only Formula)}},
  fonttitle=\small\bfseries]
