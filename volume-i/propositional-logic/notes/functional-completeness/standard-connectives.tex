...
\begin{tcolorbox}[colback=thmbox, colframe=thmborder, arc=2pt,
  ...
  title={\small\textbf{Theorem (Standard Connectives are Functionally Complete)}},
...
\begin{tcolorbox}[colback=thmbox, colframe=thmborder, arc=2pt,
  left=6pt, right=6pt, top=4pt, bottom=4pt,
  title={\small\textbf{Theorem (Negation and Conjunction are Functionally Complete)}},
  fonttitle=\small\bfseries]
...
\begin{tcolorbox}[colback=thmbox, colframe=thmborder, arc=2pt,
  left=6pt, right=6pt, top=4pt, bottom=4pt,
  title={\small\textbf{Theorem (Negation and Disjunction are Functionally Complete)}},
  fonttitle=\small\bfseries]
