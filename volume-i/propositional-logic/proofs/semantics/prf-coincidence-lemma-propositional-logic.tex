...
\begin{remark*}[Return]
\hyperref[lem:coincidence-lemma-propositional-logic]{Return to Theorem}
\end{remark*}
...
\LRAProofBodyStart
TODO: professional standard proof for coincidence-lemma-propositional-logic.
\end{proof}

\begin{proof}[Detailed Learning Proof]
\LRAProofBodyStart
TODO: detailed learning proof for coincidence-lemma-propositional-logic.
\end{proof}
