% BEGIN GENERATED ARTIFACT: prf:existence-conjunctive-normal-form-propositional-logic
\newpage
\phantomsection
...
\begin{remark*}[Return]
\hyperref[thm:existence-conjunctive-normal-form-propositional-logic]{Return to Theorem (Existence of Conjunctive Normal Form).}
\end{remark*}

\begin{theorem*}[Existence of Conjunctive Normal Form]
For every formula \(\varphi\in\WFF\), there exists a formula
\(\psi\in\WFF\) such that \(\psi\) is in conjunctive normal form and
\[
\varphi\equiv\psi.
\]
\end{theorem*}
...
conjunction of clauses. Replacement of logical equivalents preserves
equivalence through each local transformation.
\end{remark*}
...
\clearpage
% END GENERATED ARTIFACT: prf:existence-conjunctive-normal-form-propositional-logic
