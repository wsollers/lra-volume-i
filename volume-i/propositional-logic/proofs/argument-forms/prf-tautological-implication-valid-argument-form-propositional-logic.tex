...
Assume all premises are true under a truth assignment. Since the implication
from their conjunction to the conclusion is tautological, the conclusion must be true.
\end{remark*}
