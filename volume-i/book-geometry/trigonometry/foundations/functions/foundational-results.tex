...
rectifiability machinery not yet developed in this volume. The later
unit-circle discussion depends on
\hyperref[def:euclid-circle]{circles},
\hyperref[def:cartesian-product]{Cartesian products}, and
\hyperref[thm:sine-cosine-well-defined]{well-definedness of sine and cosine}.
\end{remark*}
