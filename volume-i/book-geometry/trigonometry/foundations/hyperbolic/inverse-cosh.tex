\input{volume-i/book-geometry/trigonometry/foundations/hyperbolic/figure-inverse-hyperbolic-cosh}
...
$\operatorname{arccosh}$ and has domain $[1,\infty)$ and range $[0,\infty)$.
\[
  \operatorname{arccosh} x=t
