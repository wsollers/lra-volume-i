\input{volume-i/book-geometry/trigonometry/foundations/hyperbolic/figure-inverse-hyperbolic-sech}
...
$[0,\infty)$. It is denoted by $\operatorname{arcsech}$ and has domain
$(0,1]$ and range $[0,\infty)$.
\[
  \operatorname{arcsech} x=t
...
For every $x\in(0,1]$,
\[
  \operatorname{sech}(\operatorname{arcsech} x)=x.
\]
For every $t\in[0,\infty)$,
\[
  \operatorname{arcsech}(\operatorname{sech} t)=t.
\]
\end{theorem}
\end{theorembox}
\begin{remark*}[Standard quantified statement]
