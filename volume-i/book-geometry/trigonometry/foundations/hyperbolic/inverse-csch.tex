\input{volume-i/book-geometry/trigonometry/foundations/hyperbolic/figure-inverse-hyperbolic-csch}
...
$\operatorname{arcsch}$ and has domain $\mathbb{R}\setminus\{0\}$ and range
$\mathbb{R}\setminus\{0\}$.
\[
  \operatorname{arcsch} x=t
