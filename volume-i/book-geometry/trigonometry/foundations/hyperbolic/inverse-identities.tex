...
\begin{remark*}[Proof]
Let $t=\operatorname{arsinh}x$. Then $x=\sinh t=(e^t-e^{-t})/2$. With
...
\begin{remark*}[Proof]
Let $t=\operatorname{arcosh}x$. Then $t\geq 0$ and
...
\begin{remark*}[Proof]
Let $t=\operatorname{artanh}x$. Then
\[
...
\begin{remark*}[Proof]
Let $t=\operatorname{arcoth}x$. Then
\[
...
\begin{remark*}[Proof]
Let $t=\operatorname{arsech}x$. Then $t\geq 0$ and
$x=\operatorname{sech}t=1/\cosh t$, so $\cosh t=1/x$. Since $0<x\leq 1$,
we have $1/x\in[1,\infty)$, and the definition of $\operatorname{arcosh}$
...
\begin{remark*}[Proof]
Let $t=\operatorname{arcsch}x$. Then
$x=\operatorname{csch}t=1/\sinh t$, so $\sinh t=1/x$. The definition of
$\operatorname{arsinh}$ gives the displayed identity.
\end{remark*}
\begin{dependencies}
\begin{itemize}
