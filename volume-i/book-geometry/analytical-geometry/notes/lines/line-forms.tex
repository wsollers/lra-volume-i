\begin{definitionbox}{Definition (Point-Slope Form)}
...
The equation records all points whose slope relative to $P_1$ is $m$.
\end{remark*}

\begin{remark*}[Exposition]
The formula is obtained by setting the slope from $P_1$ to an arbitrary point
$(x,y)$ equal to $m$.
\end{remark*}
...
\begin{definitionbox}{Definition (Two-Point Form)}
\begin{definition}[Two-Point Form]\label{def:two-point-form}
...
\begin{remark*}[Interpretation]
The slope is determined by the two given points and then inserted into
point-slope form.
\end{remark*}
...
\begin{definitionbox}{Definition (General Linear Form)}
\begin{definition}[General Linear Form]\label{def:general-linear-form}
...
and avoids the exceptional cases present in slope-based forms.
\end{remark*}
...
\begin{definitionbox}{Definition (Vector Parametric Form)}
\begin{definition}[Vector Parametric Form]\label{def:vector-parametric-form}
...
\begin{remark*}[Interpretation]
A parametric line starts at a point and moves in a fixed nonzero direction.
\end{remark*}
...
\begin{definitionbox}{Definition (Intercept Form)}
\begin{definition}[Intercept Form]\label{def:intercept-form}
...
\begin{remark*}[Interpretation]
The intercept form records a line by the two nonzero axis intercepts it
passes through.
\end{remark*}

\begin{remark*}[Exposition]
The intercept form follows by applying the two-point form to $(a,0)$ and
$(0,b)$ and rearranging the resulting equation.
\end{remark*}
...
\begin{definitionbox}{Definition (Affine Parametric Line in $\mathbb{R}^n$)}
\begin{definition}[Affine Parametric Line in $\mathbb{R}^n$]\label{def:affine-parametric-line}
...
\begin{remark*}[Interpretation]
The parameter $t$ moves through the point $\mathbf x_1$ in the direction
$\mathbf x_2-\mathbf x_1$.
\end{remark*}
...
\begin{definitionbox}{Definition (Normal Form)}
\begin{definition}[Normal Form]\label{def:normal-form-line}
...
\begin{remark*}[Interpretation]
Normal form records a line by a unit normal direction and its distance from
the origin.
\end{remark*}
...
\begin{definitionbox}{Definition (Symmetric Form)}
\begin{definition}[Symmetric Form]\label{def:symmetric-form-line}
...
parametric equations $x=x_1+r\cos\theta$ and $y=y_1+r\sin\theta$.
\end{remark*}

\begin{remark*}[Interpretation]
Symmetric form presents the same parameter value across the coordinate
