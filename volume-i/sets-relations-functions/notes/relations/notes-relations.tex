...
\begin{propositionbox}{Definition (Ordered Pair)}
...
\begin{propositionbox}{Definition (Cartesian Product — as foundation for relations)}
...
\begin{propositionbox}{Definition (Relation)}
\label{def:relation}
