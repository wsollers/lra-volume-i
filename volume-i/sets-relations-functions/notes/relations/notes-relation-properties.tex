...
% Structural classes
% ---------------------------------------------------------
\begin{propositionbox}{Definition (Equivalence Relation)}
...
\begin{propositionbox}{Definition (Preorder)}
\label{def:preorder}
...
\begin{propositionbox}{Definition (Partial Order)}
...
\begin{propositionbox}{Definition (Total Order)}
