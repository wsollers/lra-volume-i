...
\begin{propositionbox}{Definition (Equivalence Class)}
...
\begin{propositionbox}{Definition (Quotient Set)}
...
\begin{propositionbox}{Definition (Canonical Surjection)}
...
\begin{propositionbox}{Definition (Partition)}
\label{def:partition}
