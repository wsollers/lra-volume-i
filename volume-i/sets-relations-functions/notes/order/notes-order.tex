...
\begin{propositionbox}{Definition (Ordered Set)}
...
\begin{propositionbox}{Definition (Strict Order)}
...
\begin{propositionbox}{Definition (Total / Linear Order)}
...
% ---------------------------------------------------------
\begin{propositionbox}{Definition (Upper and Lower Bounds)}
\label{def:bounds}
...
% Well-order
% ---------------------------------------------------------
\begin{propositionbox}{Definition (Well-Ordered Set)}
...
\begin{propositionbox}{Definition (Directed Set)}
...
\begin{propositionbox}{Definition (Net)}
\label{def:net}
