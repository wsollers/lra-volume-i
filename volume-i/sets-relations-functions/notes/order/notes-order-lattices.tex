...
\begin{propositionbox}{Definition (Lattice)}
\label{def:lattice}
...
\begin{propositionbox}{Definition (Complete Lattice)}
...
\begin{propositionbox}{Definition (Distributive Lattice)}
...
\begin{propositionbox}{Definition (Complement and Boolean Lattice)}
