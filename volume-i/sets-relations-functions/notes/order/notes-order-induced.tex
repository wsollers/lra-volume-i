...
\begin{propositionbox}{Definition (Induced Order)}
...
\begin{propositionbox}{Definition ($f$-Indistinguishable Elements)}
\label{def:f-indist}
...
\begin{propositionbox}{Definition (Suborder / Restriction)}
\label{def:suborder}
...
\begin{propositionbox}{Definition (Order Embedding)}
