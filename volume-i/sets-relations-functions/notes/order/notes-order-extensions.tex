...
% ---------------------------------------------------------
\begin{propositionbox}{Definition (Symmetric and Asymmetric Parts)}
\label{def:sym-asym}
...
% Preorder and loset
% ---------------------------------------------------------
\begin{propositionbox}{Definition (Preorder and Loset)}
...
% ---------------------------------------------------------
\begin{propositionbox}{Definition (Maximal Elements and Upper Bounds)}
...
% Transitive closure
% ---------------------------------------------------------
\begin{propositionbox}{Definition (Transitive Closure)}
...
% ---------------------------------------------------------
\begin{propositionbox}{Definition (Extension of a Preorder)}
...
% ---------------------------------------------------------
\begin{propositionbox}{Definition and Proposition (Only Weak Cycles)}
\label{def:owc}
