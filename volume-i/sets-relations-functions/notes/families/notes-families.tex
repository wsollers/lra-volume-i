...
\begin{propositionbox}{Definition (Indexed Family of Sets)}
...
\begin{propositionbox}{Definition (Indexed Union)}
...
\begin{propositionbox}{Definition (Indexed Intersection)}
...
\begin{propositionbox}{Definition (Pairwise Disjoint Family)}
...
\begin{propositionbox}{Definition (Arbitrary Cartesian Product)}
