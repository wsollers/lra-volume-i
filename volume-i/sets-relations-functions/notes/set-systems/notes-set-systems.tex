...
\begin{propositionbox}{Definition (Semiring of Sets)}
\label{def:semiring}
...
$[a,b)$ are easy to write down. The general extension theorem (Carathéodory's
...
\begin{propositionbox}{Definition (Ring of Sets)}
...
\begin{propositionbox}{Definition (Algebra of Sets)}
...
\begin{propositionbox}{Definition ($\sigma$-Algebra)}
...
\begin{propositionbox}{Definition (Topology)}
\label{def:topology-defn}
...
\begin{propositionbox}{Definition (Generated $\sigma$-Algebra)}
\label{def:generated-sigma}
...
\begin{propositionbox}{Definition (Borel $\sigma$-Algebra)}
\label{def:borel}
