...
% Empty Set
% ---------------------------------------------------------
\begin{propositionbox}{Definition (Empty Set)}
\label{def:empty-set}
...
% ---------------------------------------------------------
\begin{propositionbox}{Definition (Subset)}
\label{def:subset}
...
\begin{propositionbox}{Definition (Proper Subset)}
...
\begin{propositionbox}{Definition (Set Equality)}
...
% Set Operations
% ---------------------------------------------------------
\begin{propositionbox}{Definition (Union)}
\label{def:union}
...
\input{volume-i/sets-relations-functions/notes/sets/figure-union}

\begin{propositionbox}{Definition (Intersection)}
...
\input{volume-i/sets-relations-functions/notes/sets/figure-intersection}

\begin{propositionbox}{Definition (Set Difference)}
...
\input{volume-i/sets-relations-functions/notes/sets/figure-set-difference}

\begin{propositionbox}{Definition (Symmetric Difference)}
\label{def:sym-diff}
...
\input{volume-i/sets-relations-functions/notes/sets/figure-symmetric-difference}
...
\begin{propositionbox}{Definition (Complement)}
...
\begin{propositionbox}{Definition (Cartesian Product)}
...
\begin{propositionbox}{Definition (Power Set)}
\label{def:power-set}
