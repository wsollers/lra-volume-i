...
\begin{propositionbox}{Definition (Same Cardinality)}
...
\begin{propositionbox}{Definition (Finite and Infinite Sets)}
...
\begin{propositionbox}{Definition (Countable and Uncountable Sets)}
\label{def:countable}
...
\begin{propositionbox}{Definition (Comparing Cardinalities)}
...
\begin{propositionbox}{Definition (Function Space $B^A$)}
