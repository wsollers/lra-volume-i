...
\begin{propositionbox}{Definition (Composition)}
...
% Inverse functions
% ---------------------------------------------------------
\begin{propositionbox}{Definition (Inverse Function)}
\label{def:inverse}
...
% One-sided inverses
% ---------------------------------------------------------
\begin{propositionbox}{Definition (Left and Right Inverses)}
...
% ---------------------------------------------------------
\begin{propositionbox}{Definition (Restriction and Extension)}
