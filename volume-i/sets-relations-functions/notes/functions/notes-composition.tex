...
% One-sided inverses
% ---------------------------------------------------------
\begin{definitionbox}{Definition (Left and Right Inverses)}
\begin{definition}[Left and Right Inverses]\label{def:left-right-inverse}
Let $f : A \to B$.
...
\begin{itemize}
  \item \hyperref[def:function]{Function}
  \item \hyperref[def:composition]{Composition}
  \item \hyperref[def:left-right-inverse]{Left and Right Inverses}
  \item \hyperref[def:injective]{Injective Function}
  \item \hyperref[def:surjective]{Surjective Function}
  \item \hyperref[def:bijective]{Bijective Function}
\end{itemize}
...
% ---------------------------------------------------------
\begin{definitionbox}{Definition (Restriction and Extension)}
\begin{definition}[Restriction and Extension]\label{def:restriction}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{def:restriction}.
\end{itemize}
\end{dependencies}
