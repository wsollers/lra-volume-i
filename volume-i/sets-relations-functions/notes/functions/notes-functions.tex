...
\begin{definitionbox}{Definition (Domain and Codomain)}
\begin{definition}[Domain and Codomain]\label{def:domain-codomain}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{def:domain-codomain}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{def:fiber}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{def:graph}.
\end{itemize}
\end{dependencies}
...
% Special functions
% ---------------------------------------------------------
\begin{definitionbox}{Definition (Identity and Inclusion)}
\begin{definition}[Identity and Inclusion]\label{def:identity}
