...
\begin{definitionbox}{Toolkit: Ordered Sets}
...
A \hyperref[def:partial-order]{partial order} $\leq$ on a set $S$ is a
...
\hyperref[def:strict-partial-order]{strict partial order}.
\end{remark*}
