...
\begin{tcolorbox}[
  ...
  title={\small\textbf{Toolkit: Chains and Antichains}},
...
\begin{tcolorbox}[colback=defbox, colframe=defborder, arc=2pt,
  ...
  title={\small\textbf{Definition (Chain)}},
  fonttitle=\small\bfseries]
...
\hyperref[def:total-order]{total order} on $C$.
\end{definition}
\end{tcolorbox}
...
\hyperref[def:total-order]{total order}.
\end{remark*}
...
\begin{tcolorbox}[colback=defbox, colframe=defborder, arc=2pt,
  left=6pt, right=6pt, top=4pt, bottom=4pt,
  title={\small\textbf{Definition (Antichain)}},
  fonttitle=\small\bfseries]
