...
\[
(\Gamma,\varphi)\in\mathsf{ArgumentForm}
\Longleftrightarrow
...
\((\Gamma,\varphi)\in\mathsf{ArgumentForm}\) means that \(\Gamma\) is the set
...
\begin{remark*}[Standard quantified statement]
\[
\operatorname{Valid}(\Gamma,\varphi)
\Longleftrightarrow
...
\begin{remark*}[Predicate reading]
\(\operatorname{Valid}(\Gamma,\varphi)\) means that truth of all
...
\begin{remark*}[Standard quantified statement]
\[
v\in\mathsf{CounterexampleAssignment}(\Gamma,\varphi)
\Longleftrightarrow
...
\begin{remark*}[Predicate reading]
\(v\in\mathsf{CounterexampleAssignment}(\Gamma,\varphi)\) means that \(v\)
...
\operatorname{Valid}(\Gamma,\varphi)
\Longleftrightarrow
\neg(\exists v)\bigl(v\in\mathsf{CounterexampleAssignment}(\Gamma,\varphi)\bigr).
\]
\end{remark*}
