...
\(P\in\mathsf{PropositionalVariable}\) means \(P\in\Prop\).
\end{remark*}
...
\begin{remark*}[Predicate reading]
\(\varphi\in\mathsf{WellFormedFormula}\) means \(\varphi\in\WFF\), read as ``\(\varphi\) is a well-formed formula.''
\end{remark*}
...
\(\sigma\notin\mathsf{WellFormedFormula}\) means the string \(\sigma\) is excluded by at least one formation-closed set containing \(\Prop\); equivalently, it is not generated by finitely many applications of the formation rules.
\end{remark*}
...
\begin{remark*}[Predicate reading]
\(\varphi\in\mathsf{AtomicFormula}\) means that \(\varphi\) is a propositional variable viewed as a well-formed formula.
\end{remark*}
...
\begin{remark*}[Predicate reading]
\(\varphi\in\mathsf{MolecularFormula}\) means that \(\varphi\) has nontrivial connective structure.
\end{remark*}
