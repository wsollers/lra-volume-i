...
\begin{definitionalbox}{Definitional Root (Truth Value)}
...
\begin{definitionalbox}{Definitional Root (Propositional Language)}
...
\end{enumerate}
\end{definition}
\LeanFormalizes{def:propositional-language}{lra-lean}{LRA.VolumeI.Logic.Language.Propositional.PropositionalLanguage}{PropositionalLanguage}{pending}
\end{definitionalbox}
...
\begin{definitionbox}{Definition (Propositional Variable)}
...
\begin{remark*}[Standard quantified statement]
\[
P\in\mathsf{PropositionalVariable}\Longleftrightarrow P\in\Prop.
\]
\end{remark*}

\begin{remark*}[Predicate reading]
\[
  P\in\mathsf{PropositionalVariable}
\] means \(P\in\Prop\).
\end{remark*}
...
\begin{definitionbox}{Definition (Logical Connective)}
...
\]
\end{definition}
\LeanFormalizes{def:logical-connective}{lra-lean}{LRA.VolumeI.Logic.Language.Notation.LogicalSymbols}{LogicalConnective}{pending}
\LeanFormalizes{def:logical-connective}{lra-lean}{LRA.VolumeI.Logic.Language.Notation.LogicalSymbols}{LogicalConnectives}{pending}
\end{definitionbox}

\begin{remark*}[Standard quantified statement]
\[
\neg\in\mathsf{UnaryConnective}
\quad\text{and}\quad
\land,\lor,\to,\leftrightarrow\in\mathsf{BinaryConnective}.
\]
\end{remark*}
...
\end{enumerate}
\end{definition}
\LeanFormalizes{def:well-formed-formula}{lra-lean}{LRA.VolumeI.Logic.Syntax.Propositional.Formula}{Formula}{pending}
\end{definitionbox}
...
\begin{remark*}[Predicate reading]
\[
  \varphi\in\mathsf{WellFormedFormula}
\] means \(\varphi\in\WFF\), read as ``\(\varphi\) is a well-formed formula.''
\end{remark*}
...
\[
  \sigma\notin\mathsf{WellFormedFormula}
\] means the string \(\sigma\) is excluded by at least one formation-closed set containing \(\Prop\); equivalently, it is not generated by finitely many applications of the formation rules.
\end{remark*}

\begin{remark*}[Failure modes]
\begin{description}
  \item[Exposition.] A string fails to be well formed when it violates the formation grammar: an
operand may be missing, a connective may be missing, parentheses may be
unmatched, or the string may not be generated by finitely many formation steps.
\end{description}
\end{remark*}

\begin{remark*}[Failure modes]
\begin{description}
  \item[Exposition.] The named branch below records the displayed failure mode.
\item[\(\mathsf{WellFormedFormula}\) fails.] \[
...
\begin{lemmabox}{Lemma (Closure Under Formation)}
...
\begin{theorembox}{Theorem (Minimality of Well-Formed Formulas)}
...
\end{definition}
\LeanFormalizes{def:atomic-formula-propositional-logic}{lra-lean}{LRA.VolumeI.Logic.Syntax.Propositional.Formula}{Formula.atom}{pending}
\end{definitionbox}

\begin{remark*}[Standard quantified statement]
\[
\varphi\in\mathsf{AtomicFormula}
\Longleftrightarrow
...
\[
  \varphi\in\mathsf{AtomicFormula}
\] means that \(\varphi\) is a propositional variable viewed as a well-formed formula.
\end{remark*}
...
\begin{remark*}[Standard quantified statement]
\[
\varphi\in\mathsf{MolecularFormula}
\Longleftrightarrow
\varphi\in\WFF\land\varphi\notin\mathsf{AtomicFormula}.
\]
\end{remark*}
...
\[
  \varphi\in\mathsf{MolecularFormula}
\] means that \(\varphi\) has nontrivial connective structure.
\end{remark*}
...
\begin{definitionbox}{Definition (Main Connective)}
...
\begin{remark*}[Predicate reading]
\[
  \operatorname{MainConnective}(\varphi,c)
\] means that \(c\) is the outermost connective introduced in the final formation step of \(\varphi\).
\end{remark*}
...
\begin{theorembox}{Theorem (Structural Induction for Propositional Formulas)}
...
\begin{theorembox}{Theorem (Structural Recursion for Propositional Formulas)}
...
\begin{lemmabox}{Lemma (Constructor Disjointness for Propositional Formulas)}
...
\begin{lemmabox}{Lemma (Constructor Injectivity for Propositional Formulas)}
...
\begin{theorembox}{Theorem (Unique Decomposition for Propositional Formulas)}
...
\begin{definitionbox}{Definition (Parse Tree)}
...
\begin{remark*}[Standard quantified statement]
\[
\mathsf{Tree}:\WFF\to\{\text{finite rooted labeled trees}\}
\]
...
\begin{theorembox}{Theorem (Unique Syntax Tree for Propositional Formulas)}
...
\begin{remark*}[Standard quantified statement]
\[
\forall\varphi\in\WFF,\quad \exists!T\; (T=\mathsf{Tree}(\varphi)).
\]
\end{remark*}
...
\begin{definitionbox}{Definition (Variable Set of a Formula)}
...
\begin{definitionbox}{Definition (Subformula)}
...
\begin{definitionbox}{Definition (Proper Subformula)}
...
\begin{definitionbox}{Definition (Connective Count)}
...
\begin{lemmabox}{Lemma (Proper Subformula Depth)}
...
\begin{lemmabox}{Lemma (Finiteness of Variables in a Formula)}
...
\begin{lemmabox}{Lemma (Finiteness of Subformulas)}
