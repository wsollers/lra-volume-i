...
\begin{definitionbox}{Definition (Literal)}
...
\begin{definitionbox}{Definition (Positive Literal)}
...
\begin{definitionbox}{Definition (Negative Literal)}
...
\begin{definitionbox}{Definition (Complementary Literals)}
...
\begin{definitionbox}{Definition (Clause)}
...
\begin{definitionbox}{Definition (Empty Clause)}
...
\begin{definitionbox}{Definition (Empty Conjunction)}
