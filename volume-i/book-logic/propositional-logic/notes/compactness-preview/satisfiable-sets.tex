...
\begin{remark*}[Failure modes]
\begin{description}
  \item[Exposition.] The failure mode records the negation of unsatisfiability.
  \item[\(\operatorname{Unsatisfiable}\) fails.] The unsatisfiability predicate
  fails exactly when a satisfying truth assignment exists:
  \[
  \neg\operatorname{Unsatisfiable}(\Gamma)
  \Longleftrightarrow
  \operatorname{Satisfiable}(\Gamma).
