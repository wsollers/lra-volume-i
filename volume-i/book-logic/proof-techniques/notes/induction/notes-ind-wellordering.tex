...
% =========================================================
\noindent\begin{propositionbox}{Well-Ordering Principle}
...
\begin{propositionbox}{Proposition (Induction and well-ordering are equivalent)}
\begin{proposition}[Induction and well-ordering are equivalent]
\label{prop:induction-well-ordering-equivalent}
...
\end{enumerate}
\hyperref[prf:induction-well-ordering-equivalent]{\textit{Go to proof.}}
\end{proposition}
\end{propositionbox}
\begin{remark*}[Standard quantified statement]
For every admissible object satisfying the hypotheses of the statement, the
