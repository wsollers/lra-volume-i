...
\subsection{Proof Strategies for Quantified Statements}
...
\subsection*{\texorpdfstring{Strategy 1: Proving a Universal $\forall x\,\varphi(x)$}{Strategy 1: Proving a Universal forall x phi(x)}}
...
\subsection*{\texorpdfstring{Strategy 2: Proving an Existential $\exists x\,\varphi(x)$}{Strategy 2: Proving an Existential exists x phi(x)}}
...
\subsection*{\texorpdfstring{Strategy 3: Using a Universal $\forall x\,\varphi(x)$}{Strategy 3: Using a Universal forall x phi(x)}}
...
\subsection*{\texorpdfstring{Strategy 4: Using an Existential $\exists x\,\varphi(x)$}{Strategy 4: Using an Existential exists x phi(x)}}
...
\subsection*{The Central Asymmetry: Universal vs.\ Existential Goals}
...
\subsection*{\texorpdfstring{Nested Quantifiers: The $\forall\exists$ Pattern in Analysis}{Nested Quantifiers: The forallexists Pattern in Analysis}}
...
\begin{propositionbox}{Proof Skeleton: $\forall x\,\exists y\,\varphi(x,y)$}
...
\begin{propositionbox}{Proof Skeleton: $\exists y\,\forall x\,\varphi(x,y)$}
\begin{enumerate}[label=\textbf{Step \arabic*.}]
