...
\subsection{Deduction Rules: Quantifier Inference}
...
\]
\end{definition}
\LeanFormalizes{def:ui}{lra-lean}{LRA.VolumeI.Logic.Proof.System.Takeuti.Rule}{Rule.allLeft}{pending}
\end{definitionbox}
...
\]
\end{definition}
\LeanFormalizes{def:ug}{lra-lean}{LRA.VolumeI.Logic.Proof.System.Takeuti.Rule}{Rule.allRight}{pending}
\end{definitionbox}
\begin{remark*}[Standard quantified statement]
For every admissible object satisfying the hypotheses of the statement, the
assertion holds in the formal language under discussion.
...
\]
\end{definition}
\LeanFormalizes{def:ei}{lra-lean}{LRA.VolumeI.Logic.Proof.System.Takeuti.Rule}{Rule.exLeft}{pending}
\end{definitionbox}
\begin{remark*}[Standard quantified statement]
For every admissible object satisfying the hypotheses of the statement, the
assertion holds in the formal language under discussion.
...
\]
\end{definition}
\LeanFormalizes{def:eg}{lra-lean}{LRA.VolumeI.Logic.Proof.System.Takeuti.Rule}{Rule.exRight}{pending}
\end{definitionbox}
\begin{remark*}[Standard quantified statement]
For every admissible object satisfying the hypotheses of the statement, the
assertion holds in the formal language under discussion.
