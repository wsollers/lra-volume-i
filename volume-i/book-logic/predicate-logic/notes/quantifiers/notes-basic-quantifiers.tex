...
\(\Phi\in\mathsf{UniversalFormula}\) means that \(\Phi\) is a formula
...
\begin{remark*}[Predicate reading]
\(\Phi\in\mathsf{ExistentialFormula}\) means that \(\Phi\) is a formula
...
\begin{remark*}[Predicate reading]
\(\Phi\in\mathsf{BoundedQuantifier}\) means that \(\Phi\) uses a
...
\begin{remark*}[Predicate reading]
\(\varphi\in\mathsf{Sentence}\) means that \(\varphi\) is a well-formed
...
\begin{remark*}[Predicate reading]
\(\varphi\in\mathsf{OpenFormula}\) means that \(\varphi\) has at least one
free variable.
\end{remark*}
...
\begin{remark*}[Predicate reading]
\(\varphi\in\mathsf{Scope}(x)\) means that \(\varphi\) is the scope governed
