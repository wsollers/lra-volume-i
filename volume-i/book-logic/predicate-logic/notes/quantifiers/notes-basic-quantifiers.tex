...
\end{definition}
\LeanFormalizes{def:universal-q}{lra-lean}{LRA.VolumeI.Logic.Syntax.FirstOrder.Formula}{Formula.forallQ}{pending}
\end{definitionbox}
...
\[
  \Phi\in\mathsf{UniversalFormula}
\] means that \(\Phi\) is a formula
...
\begin{description}
  \item[Exposition.] The failure mode records the negation of the universal
  formula predicate.
  \item[\(\mathsf{UniversalFormula}\) fails.] The formula fails to be universal
  exactly when its outermost constructor is not a universal quantifier:
  \[
  \Phi \text{ is not of the form } \forall x\,\varphi.
  \]
  In predicate-reading form this is recorded as
  \[
  \Phi\notin\mathsf{UniversalFormula}.
  \]
\end{description}
\end{remark*}
...
where \(x\) is a variable and \(\varphi\) is a well-formed formula.
\end{definition}
\LeanFormalizes{def:existential-q}{lra-lean}{LRA.VolumeI.Logic.Syntax.FirstOrder.Formula}{Formula.existsQ}{pending}
\end{definitionbox}
...
\begin{remark*}[Predicate reading]
\[
  \Phi\in\mathsf{ExistentialFormula}
\] means that \(\Phi\) is a formula
...
\begin{remark*}[Failure modes]
\begin{description}
  \item[Exposition.] The failure mode records the negation of the existential
  formula predicate.
  \item[\(\mathsf{ExistentialFormula}\) fails.] The formula fails to be
  existential exactly when its outermost constructor is not an existential
  quantifier:
  \[
  \Phi \text{ is not of the form } \exists x\,\varphi.
  \]
  In predicate-reading form this is recorded as
  \[
  \Phi\notin\mathsf{ExistentialFormula}.
  \]
\end{description}
\end{remark*}
...
\begin{remark*}[Predicate reading]
\[
  \Phi\in\mathsf{BoundedQuantifier}
\] means that \(\Phi\) uses a
...
\begin{remark*}[Failure modes]
\begin{description}
  \item[Exposition.] The failure mode records the negation of the bounded
  quantifier predicate.
  \item[\(\mathsf{BoundedQuantifier}\) fails.] The expression fails to be a
  bounded-quantifier form when it is not one of the displayed restricted
  universal or existential abbreviations:
  \[
  \Phi \text{ is not an abbreviation of either displayed bounded form.}
  \]
  In predicate-reading form this is recorded as
  \[
  \Phi\notin\mathsf{BoundedQuantifier}.
  \]
\end{description}
\end{remark*}
...
\end{definition}
\LeanFormalizes{def:sentence-predicate-logic}{lra-lean}{LRA.VolumeI.Logic.Syntax.FirstOrder.Sentence}{Sentence}{pending}
\LeanFormalizes{def:sentence-predicate-logic}{lra-lean}{LRA.VolumeI.Logic.Syntax.FirstOrder.Sentence}{IsClosedFormula}{pending}
\end{definitionbox}
...
\begin{remark*}[Predicate reading]
\[
  \varphi\in\mathsf{Sentence}
\] means that \(\varphi\) is a well-formed
...
\begin{remark*}[Failure modes]
\begin{description}
  \item[Exposition.] The failure modes follow the two clauses in the negated
  sentence predicate.
  \item[\(\mathsf{Form}_{\mathcal L}\) fails.] The sentence predicate fails if
  the expression is not a well-formed formula:
  \[
  \varphi\notin\mathsf{Form}_{\mathcal L}.
  \]
  In predicate-reading form this contributes to
  \[
  \varphi\notin\mathsf{Sentence}.
  \]
  \item[\(\mathsf{FV}(\varphi)\neq\varnothing\).] The sentence predicate also
  fails if the formula has at least one free variable:
  \[
  \mathsf{FV}(\varphi)\neq\varnothing.
  \]
  In predicate-reading form this contributes to
...
\begin{remark*}[Predicate reading]
\[
  \varphi\in\mathsf{OpenFormula}
\] means that \(\varphi\) has at least one
free variable.
\end{remark*}
...
\begin{description}
  \item[Exposition.] The failure modes follow the two clauses in the negated
  open-formula predicate.
  \item[\(\mathsf{Form}_{\mathcal L}\) fails.] The open-formula predicate fails
  if the expression is not a well-formed formula:
  \[
  \varphi\notin\mathsf{Form}_{\mathcal L}.
  \]
  In predicate-reading form this contributes to
  \[
  \varphi\notin\mathsf{OpenFormula}.
  \]
  \item[\(\mathsf{FV}(\varphi)=\varnothing\).] The open-formula predicate also
  fails if no variable occurs free:
  \[
  \mathsf{FV}(\varphi)=\varnothing.
  \]
  In predicate-reading form this contributes to
...
\begin{remark*}[Predicate reading]
\[
  \varphi\in\mathsf{Scope}(x)
\] means that \(\varphi\) is the scope governed
...
\begin{remark*}[Failure modes]
\begin{description}
  \item[Exposition.] The failure mode records the negation of the displayed
  scope predicate.
  \item[\(\mathsf{Scope}(x)\) fails.] The scope predicate fails when
  \(\varphi\) is not the formula governed by the displayed quantifier on \(x\):
  \[
  \varphi \text{ is not the formula governed by the displayed quantifier on } x.
  \]
  In predicate-reading form this is recorded as
