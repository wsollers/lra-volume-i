...
\(\operatorname{QuantifierPrefix}(\Pi)\) means that \(\Pi\) is a finite string
...
\begin{remark*}[Definition predicate reading]
\(\operatorname{Matrix}(\psi,\Phi)\) means that \(\psi\) is the matrix of the
formula \(\Phi\).
\end{remark*}
...
\begin{remark*}[Definition predicate reading]
\(\operatorname{PrenexFormula}(\Phi)\) means that all quantifiers of \(\Phi\)
...
\begin{remark*}[Definition predicate reading]
\(\operatorname{PrenexNormalForm}(\psi,\varphi)\) means that \(\psi\) is a
...
\(\forall\varphi\,
\exists\psi\,\operatorname{PrenexNormalForm}(\psi,\varphi)\).
\end{remark*}
