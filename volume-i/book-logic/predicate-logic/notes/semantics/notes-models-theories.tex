...
\[
  \operatorname{ModelOfSentence}(M,\varphi)
\] means that \(M\) is a model of
the sentence \(\varphi\).
\end{remark*}
...
\[
  \neg\operatorname{ModelOfSentence}(M,\varphi)
...
\begin{remark*}[Predicate reading]
\[
  \operatorname{ModelOfTheory}(M,T)
\] means that \(M\) is a model of every
sentence in \(T\).
\end{remark*}
...
\begin{remark*}[Negation predicate reading]
\[
  \neg\operatorname{ModelOfTheory}(M,T)
\] means that at least one sentence of
\(T\) is false in \(M\).
\end{remark*}
...
\[
  T\in\mathsf{Theory}
\] means that \(T\) is a set of sentences in a fixed
...
\[
  T\notin\mathsf{Theory}
\] means that \(T\) is not a set consisting only
...
\begin{remark*}[Predicate reading]
\[
  \operatorname{LogicalConsequence}(T,\varphi)
\] means that every model of
...
\begin{remark*}[Negation predicate reading]
\[
  \neg\operatorname{LogicalConsequence}(T,\varphi)
\] means that some structure
...
\begin{description}
  \item[Exposition.] The named branch below records the displayed failure mode.
\item[\(\operatorname{LogicalConsequence}\) fails.] \[
...
\begin{remark*}[Negation predicate reading]
\[
  \neg\operatorname{LogicalEquivalence}(\varphi,\psi)
\] means that some
...
\begin{description}
  \item[Exposition.] The named branch below records the displayed failure mode.
\item[\(\operatorname{LogicalEquivalence}\) fails.] \[
