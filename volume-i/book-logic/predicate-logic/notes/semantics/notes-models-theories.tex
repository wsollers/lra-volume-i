...
The only failure mode is semantic: the sentence is false in the proposed
structure.
\end{remark*}
...
\begin{remark*}[Failure modes]
A proposed model of a set of sentences fails by a single sentence of the set
...
\begin{remark*}[Failure modes]
A proposed theory fails in this minimal sense when it contains something other
...
\begin{remark*}[Failure modes]
Logical consequence fails by a countermodel: a structure satisfying all
...
\begin{remark*}[Failure modes]
Logical equivalence fails when one sentence is true and the other false in the
same structure.
\end{remark*}
