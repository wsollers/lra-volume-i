...
\begin{remark*}[Predicate reading]
\[
  \operatorname{DefinableRelation}(R,\varphi,M)
\] means that \(R\) is the
...
\begin{remark*}[Negation predicate reading]
\[
  \neg\operatorname{DefinableRelation}(R,\varphi,M)
\] means that \(R\) is not
...
\begin{description}
  \item[Exposition.] The named branch below records the displayed failure mode.
\item[\operatorname{DefinableRelation} fails.] \[
