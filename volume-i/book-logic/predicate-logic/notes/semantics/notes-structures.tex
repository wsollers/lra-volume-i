...
\(L\in\mathsf{FirstOrderLanguage}\) means that \(L\) supplies the variable
...
\(L\notin\mathsf{FirstOrderLanguage}\) means that \(L\) lacks some
...
\begin{remark*}[Predicate reading]
\(M\in\mathsf{Structure}(L)\) means that \(M\) is a structure for the
...
\begin{remark*}[Negation predicate reading]
\(M\notin\mathsf{Structure}(L)\) means that \(M\) is not a well-formed
structure for \(L\).
\end{remark*}
...
\begin{remark*}[Predicate reading]
\(s\in\mathsf{VariableAssignment}(M)\) means that \(s\) assigns a domain
...
\begin{remark*}[Negation predicate reading]
\(s\notin\mathsf{VariableAssignment}(M)\) means that \(s\) is not a
...
\begin{remark*}[Predicate reading]
\(s'\in\mathsf{ModifiedAssignment}(s,x,d)\) means that \(s'\) is the
...
\begin{remark*}[Negation predicate reading]
\(s'\notin\mathsf{ModifiedAssignment}(s,x,d)\) means that \(s'\) is not the
...
\begin{remark*}[Predicate reading]
\(a\in\mathsf{TermEvaluation}(M,s,t)\) means that the term \(t\) evaluates
...
\begin{remark*}[Negation predicate reading]
\(a\notin\mathsf{TermEvaluation}(M,s,t)\) means that \(a\) is not the value
of \(t\) in \(M\) under \(s\).
\end{remark*}
