...
\begin{remark*}[Predicate reading]
\(\operatorname{Valid}(\varphi)\) means that \(\varphi\) is satisfied in
...
\begin{remark*}[Negation predicate reading]
\(\neg\operatorname{Valid}(\varphi)\) means that some structure and
...
\begin{remark*}[Predicate reading]
\(\operatorname{Satisfiable}(\varphi)\) means that \(\varphi\) is
...
\begin{remark*}[Negation predicate reading]
\(\neg\operatorname{Satisfiable}(\varphi)\) means that no structure and
