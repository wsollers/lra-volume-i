...
\[
  K\in\mathsf{TranslationKey}
\] means that \(K\) supplies the domain and
...
\begin{remark*}[Predicate reading]
\[
  D\in\mathsf{DomainOfDiscourse}(K)
\] means that \(D\) is the domain fixed
...
\begin{remark*}[Predicate reading]
\[
  P\in\mathsf{TranslationPredicateSymbol}(K)
\] records that \(P\) has a
...
\begin{remark*}[Predicate reading]
\[
  c\in\mathsf{TranslationConstant}(K)
\] means that \(c\) names a fixed
...
\begin{remark*}[Predicate reading]
\[
  (A,B)\in\mathsf{UniversalTranslationPattern}
...
\begin{remark*}[Predicate reading]
\[
  (A,B)\in\mathsf{ExistentialTranslationPattern}
...
\begin{remark*}[Predicate reading]
\[
  (A,B)\in\mathsf{ConditionalTranslationPattern}
\] records the implication
...
\begin{remark*}[Predicate reading]
\[
  (\varphi,\psi)\in\mathsf{NegationTranslationPattern}
\] records that
...
\begin{remark*}[Predicate reading]
\[
  \operatorname{ScopeAmbiguity}(E,\varphi,\psi)
