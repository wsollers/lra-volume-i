...
\begin{tcolorbox}[
  ...
  title={\small\textbf{Toolkit: Maps Between Ordered Sets}},
...
\begin{tcolorbox}[colback=defbox, colframe=defborder, arc=2pt,
  ...
  title={\small\textbf{Definition (Order-Preserving Map)}},
  fonttitle=\small\bfseries]
...
\begin{tcolorbox}[colback=defbox, colframe=defborder, arc=2pt,
  left=6pt, right=6pt, top=4pt, bottom=4pt,
  title={\small\textbf{Definition (Order-Isomorphism)}},
  fonttitle=\small\bfseries]
\begin{definition}[Order-Isomorphism]
\label{def:order-isomorphism}
An \hyperref[def:order-embedding]{order-embedding} $\varphi : P \to Q$
...
\begin{remark*}[Dependencies]
\hyperref[def:order-embedding]{Order-embedding},
\hyperref[def:partial-order]{anti-symmetry of partial orders}.
\end{remark*}
