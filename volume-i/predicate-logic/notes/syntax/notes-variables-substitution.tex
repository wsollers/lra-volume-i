...
% Scope
% ---------------------------------------------------------
\begin{propositionbox}{Definition (Scope of a Quantifier)}
\label{def:scope}
...
% ---------------------------------------------------------
\begin{propositionbox}{Definition (Bound and Free Occurrences)}
...
% Free Variables FV(φ)
% ---------------------------------------------------------
\begin{propositionbox}{Definition (Free Variables of a Formula)}
\label{def:fv}
...
% Sentence
% ---------------------------------------------------------
\begin{propositionbox}{Definition (Sentence)}
\label{def:sentence}
...
% Alpha-Equivalence
% ---------------------------------------------------------
\begin{propositionbox}{Definition (Alpha-Equivalence)}
