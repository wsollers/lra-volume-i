...
\section{Semantics: Open Formulas, Definable Relations, and Substitution Lemmas}
...
An expression fails to be an open formula when it is not a well-formed formula
...
\begin{remark*}[Failure modes]
A proposed definable relation fails when at least one tuple is included or
