...
\begin{remark*}[Predicate reading]
$\operatorname{PreimagePreservesUnion}(f,S,T)$,
$\operatorname{PreimagePreservesIntersection}(f,S,T)$,
$\operatorname{PreimagePreservesDifference}(f,S,T)$, and
$\operatorname{PreimagePreservesComplement}(f,S)$ mean that preimage converts
...
\begin{remark*}[Predicate reading]
$\operatorname{PreimagePreservesIndexedUnion}(f,\{T_i\}_{i\in I})$ and
$\operatorname{PreimagePreservesIndexedIntersection}(f,\{T_i\}_{i\in I})$ mean
...
\begin{remark*}[Predicate reading]
$\operatorname{ImagePreservesUnion}(f,S,T)$ means that $f(S\cup T)=f(S)\cup
f(T)$. The predicates $\operatorname{ImageIntersectionInclusion}(f,S,T)$ and
$\operatorname{ImageDifferenceInclusion}(f,S,T)$ record the one-sided image
