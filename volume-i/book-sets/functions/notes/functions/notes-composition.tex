...
\begin{remark*}[One-sided inverses]
...
\begin{remark*}[Forward to controlled restrictions]
...
\begin{remark*}[Images, preimages, and Boolean operations]
\mbox{}\par\smallskip
\small
...
\begin{remark*}[Composition and inverse interaction]
\mbox{}\par\smallskip
\small
\begin{tabularx}{\textwidth}{l X X}
\toprule
