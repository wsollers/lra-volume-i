...
$\mathsf{Lattice}(L,\leq,\vee,\wedge)$ means that every pair of elements of
...
\begin{remark*}[Predicate reading]
$\mathsf{CompleteLattice}(L,\leq,\vee,\wedge)$ means every subset of $L$ has a
supremum and an infimum in $L$.
\end{remark*}
...
\begin{remark*}[Predicate reading]
$\mathsf{DistributiveLattice}(L,\leq,\vee,\wedge)$ means meet distributes over
...
\begin{remark*}[Predicate reading]
$\mathsf{BooleanLattice}(L,\leq,\vee,\wedge,{}',\bot,\top)$ means every element
