...
\begin{exposition}
The definitions of upper and lower bound were given in
\hyperref[def:upper-bound]{the Ordered Sets section}.  For convenience
...
the Lattices chapter.  Lattices are the precise abstract setting for the
