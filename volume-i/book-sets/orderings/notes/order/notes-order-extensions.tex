...
\[
  \operatorname{SymmetricPart}(I,R,X)
\] records the mutually related pairs of
...
\begin{remark*}[Predicate reading]
\[
  \operatorname{MaximalElement}(x,X,\mathsf{OrderedSet}(X,\succsim))
\] means that
...
\begin{remark*}[Predicate reading]
\[
  \operatorname{CompletePreorderExtension}(\succsim',\succsim,X)
\] means that
...
\begin{remark*}[Predicate reading]
\[
  \operatorname{OnlyWeakCycles}(\succsim,X)
\] means that no finite chain of weak
...
\[
  \operatorname{OnlyWeakCycles}(\succsim,X)
\] is exactly the obstruction-free
