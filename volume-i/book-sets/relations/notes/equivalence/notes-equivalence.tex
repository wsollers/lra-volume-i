...
\[
  \operatorname{EquivalenceClass}(C,a,R,A)
  \iff
  \forall x,\ (x\in C \leftrightarrow x\in A \wedge (a,x)\in R).
\]
\end{remark*}

\begin{remark*}[Interpretation]
An equivalence class collects all elements that are equivalent to a fixed
representative.
\end{remark*}
...
\[
  ...
  C\in A/R
  \iff
  \exists a\in A,\ C=[a]_R.
\]
\end{remark*}

\begin{remark*}[Predicate reading]
\[
  \operatorname{QuotientSet}(Q,A,R)
  \iff
  \forall C,\ (C\in Q \leftrightarrow \exists a\in A,\ \operatorname{EquivalenceClass}(C,a,R,A)).
\]
\end{remark*}

\begin{remark*}[Interpretation]
The quotient set replaces elements of $A$ by their equivalence classes.
\end{remark*}
...
\begin{remark*}[Interpretation]
The index counts how many equivalence classes the relation creates.
\end{remark*}
...
\begin{remark*}[Predicate reading]
\[
  \operatorname{CanonicalQuotientMap}(\pi,A,R,A/R)
  \iff
  \forall a\in A,\ \pi(a)=[a]_R.
\]
\end{remark*}

\begin{remark*}[Interpretation]
The canonical quotient map sends each element to the class it represents.
\end{remark*}
...
\begin{remark*}[Standard quantified statement]
\[
  \operatorname{Partition}(\mathcal{P},A)
  \iff
  \Bigl(\forall P\in\mathcal{P},\ P\neq\varnothing\Bigr)
  \wedge
  \Bigl(\forall P,Q\in\mathcal{P},\ P\neq Q\to P\cap Q=\varnothing\Bigr)
  \wedge
...
\[
  ...
  \Bigl(\forall P,Q\in\mathcal{P},\ P\neq Q\to P\cap Q=\varnothing\Bigr)
  \wedge
  \operatorname{Covers}(\mathcal{P},A).
\]
\end{remark*}

\begin{remark*}[Interpretation]
A partition cuts a set into nonempty pieces with no overlap between distinct
pieces and no elements left uncovered.
\end{remark*}
...
\[
  ...
  \operatorname{SetEqual}([a]_R,[b]_R)
  \iff
  (a,b)\in R.
\]
\end{remark*}
...
\begin{remark*}[Interpretation]
The equivalence class does not depend on the chosen representative: two
representatives determine the same class exactly when they are equivalent.
\end{remark*}
...
\[
  ...
  \to
  \operatorname{Partition}(A/R,A),
\]
\[
  \operatorname{Partition}(\mathcal{P},A)
  \to
  \operatorname{EquivalenceRelation}(R_{\mathcal{P}},A).
\]
\end{remark*}

\begin{remark*}[Interpretation]
Equivalence relations and partitions encode the same structure: one describes
when elements are related, and the other describes the resulting blocks.
\end{remark*}
...
\begin{remark*}[Standard quantified statement]
\[
  \Bigl(\forall a,b \in A,\; (a,b)\in R \to f(a) = f(b)\Bigr)
  \leftrightarrow
  \Bigl(\exists!\,\bar f:A/R\to B,\; \forall a\in A,\ \bar f([a])=f(a)\Bigr).
\]
\end{remark*}

\begin{remark*}[Predicate reading]
\[
  \operatorname{ConstantOnEquivalenceClasses}(f,R,A)
  \iff
  \exists!\,\bar f:A/R\to B,\ f=\bar f\circ\pi.
\]
\end{remark*}

\begin{remark*}[Interpretation]
A function factors through the quotient exactly when it assigns the same value
to every member of each equivalence class.
\end{remark*}
