...
\LeanFormalizes{thm:empty-set-exists-unique}{lra-lean}{LRA.VolumeI.Set.ZFCSet}{ZFCSet.ZFCProvidesEmptySet}{pending}
...
\LeanFormalizes{thm:pairing-output-exists-unique}{lra-lean}{LRA.VolumeI.Set.ZFC.Semantics.AxiomReadings}{pairingAxiomReading}{checked}
...
\LeanFormalizes{thm:union-output-exists-unique}{lra-lean}{LRA.VolumeI.Set.ZFC.Semantics.AxiomReadings}{unionAxiomReading}{checked}
...
\LeanFormalizes{cor:binary-union-exists-unique}{lra-lean}{LRA.VolumeI.Set.ZFCSet}{ZFCSet.ZFCProvidesUnion}{pending}
...
\begin{center}
\input{volume-i/book-sets/set-theory/notes/sets/figure-union-venn}
\end{center}
\[
  x\in A\cup B
  \quad\Longleftrightarrow\quad
...
\LeanFormalizes{thm:separation-output-exists-unique}{lra-lean}{LRA.VolumeI.Set.ZFC.Semantics.SetObjectBridge}{SeparationSchemaProvidesPredicateSetWitness}{pending}
...
\LeanFormalizes{cor:intersection-exists-unique}{lra-lean}{LRA.VolumeI.Set.ZFCSet}{ZFCSet.ZFCProvidesIntersection}{pending}
...
\begin{center}
\input{volume-i/book-sets/set-theory/notes/sets/figure-intersection-venn}
\end{center}
\[
  x\in A\cap B
  \quad\Longleftrightarrow\quad
...
\LeanFormalizes{cor:set-difference-exists-unique}{lra-lean}{LRA.VolumeI.Set.ZFCSet}{ZFCSet.ZFCProvidesDifference}{pending}
...
\LeanFormalizes{cor:symmetric-difference-exists-unique}{lra-lean}{LRA.VolumeI.Set.ZFCSet}{ZFCSet.ZFCProvidesSymmetricDifference}{pending}
...
\LeanFormalizes{cor:relative-complement-exists-unique}{lra-lean}{LRA.VolumeI.Set.ZFCSet}{ZFCSet.ComplementSpec}{pending}
...
\LeanFormalizes{thm:power-set-output-exists-unique}{lra-lean}{LRA.VolumeI.Set.ZFC.Theory.Axioms}{powerSetAxiom}{pending}
...
\begin{center}
\input{volume-i/book-sets/set-theory/notes/sets/figure-order-monotone-antitone}
\end{center}
\[
  A\subseteq B
