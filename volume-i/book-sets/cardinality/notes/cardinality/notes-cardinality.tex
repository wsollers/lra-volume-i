...
\[
  \operatorname{SameCardinality}(A,B)
\] means that there is a bijection from
$A$ onto $B$.
\end{remark*}
...
\begin{remark*}[Predicate reading]
\[
  \operatorname{FiniteSet}(A)
\] means that $A$ is empty or bijective with an
...
\begin{remark*}[Predicate reading]
\[
  \operatorname{CountableSet}(A)
\] means that $A$ is finite or can be listed by
...
\begin{remark*}[Predicate reading]
\[
  \operatorname{CardinalityLeq}(A,B)
\] means that an injective copy of $A$ fits
inside $B$.
\end{remark*}
...
\[
  \operatorname{CountableSet}(\mathbb{Q})
\] means that the rational numbers can
...
If each \[
  A_n
\] is countable, then the union indexed by $\mathbb{N}$ is also
countable.
\end{remark*}
...
\begin{remark*}[Predicate reading]
\[
  \operatorname{UncountableSet}(\mathbb{R})
\] means that no natural-number-indexed
...
No function from \[
  A
\] to $\mathcal{P}(A)$ hits every subset of $A$.
\end{remark*}
...
\begin{remark*}[Predicate reading]
\[
  \operatorname{FunctionSpace}(B^A,A,B)
\] means that $B^A$ is the set of all
