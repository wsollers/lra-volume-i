...
Canonical overlay: capabilities/overlays/lra-volume-i.md
...
Repository: `lra-volume-i`
Canonical repo overlay: `capabilities/overlays/lra-volume-i.md`
Canonical route resolver:
`python <governance-root>/scripts/govpy.py capabilities/resolve.py --repo lra-volume-i --task "<user task>" --root <repo-root>`
